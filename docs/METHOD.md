...
used to confirm that the spectral pipeline reports a target carrier when that
carrier is added to a noisy trace by design.
...
frequency domain without explicitly inserting a 0.67 Hz carrier.
